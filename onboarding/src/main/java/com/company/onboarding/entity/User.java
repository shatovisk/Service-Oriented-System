...
@Table(name = "USER_", indexes = {
        ...
        @Index(name = "IDX_USER__COMISSION", columnList = "COMISSION_ID")
})
public class User implements JmixUserDetails, HasTimeZone {
    ...
    public List<PersonStep> getSteps() {
        return steps;
    }

    public void setSteps(List<PersonStep> steps) {
        this.steps = steps;
    }
