...
public interface EmployeeRole {
    ...
    @EntityAttributePolicy(entityClass = PersonStep.class, attributes = "*", action = EntityAttributePolicyAction.VIEW)
    @EntityPolicy(entityClass = PersonStep.class, actions = {EntityPolicyAction.READ, EntityPolicyAction.UPDATE})
    void personStep();
